...
app.get('/posts/:title', function (req, res) {
    ...
    posts.forEach(function(post){
      // console.log(lodash.lowerCase(post.title),lodash.lowerCase(title))
    ...
    if(!flag){
      res.render("post",{title:"Uh oh!",post:"Post not found!"});
    }
})
app.post("/compose",function(req,res){
    const entry = {
      ...
      post: req.body.post,
      preview: lodash.truncate(req.body.post,{length:100,separator:" "})
    }
    posts.push(entry);
    res.redirect("/")
})
